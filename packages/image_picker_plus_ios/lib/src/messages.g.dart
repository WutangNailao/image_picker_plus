...
class ImagePickerApi {
  ...
  Future<PickedMedia?> pickImage(SourceSpecification source, MaxSize maxSize, int? imageQuality, bool requestFullMetadata) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.image_picker_plus_ios.ImagePickerApi.pickImage$pigeonVar_messageChannelSuffix';
    ...
    ;
    return pigeonVar_replyValue as PickedMedia?;
  }

  Future<List<PickedMedia>> pickMultiImage(MaxSize maxSize, int? imageQuality, bool requestFullMetadata, int? limit) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.image_picker_plus_ios.ImagePickerApi.pickMultiImage$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    ;
    return (pigeonVar_replyValue! as List<Object?>).cast<PickedMedia>();
  }

  Future<PickedMedia?> pickVideo(SourceSpecification source, int? maxDurationSeconds) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.image_picker_plus_ios.ImagePickerApi.pickVideo$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<List<PickedMedia>> pickMultiVideo(int? maxDurationSeconds, int? limit) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.image_picker_plus_ios.ImagePickerApi.pickMultiVideo$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<List<PickedMedia>> pickMedia(MediaSelectionOptions mediaSelectionOptions) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.image_picker_plus_ios.ImagePickerApi.pickMedia$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
