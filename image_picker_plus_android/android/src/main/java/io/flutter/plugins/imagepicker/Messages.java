...
public class Messages {
   ...
   * Generated class from Pigeon that represents data sent in messages.
   */
  public static final class PickedMedia {
    ...
    public @Nullable String getContentUri() {
      return contentUri;
    }

    public void setContentUri(@Nullable String setterArg) {
      this.contentUri = setterArg;
    }
    ...
    public boolean equals(Object o) {
      if (this == o) { return true; }
      if (o == null || getClass() != o.getClass()) { return false; }
      PickedMedia that = (PickedMedia) o;
      return path.equals(that.path) && Objects.equals(contentUri, that.contentUri) && Objects.equals(mimeType, that.mimeType);
    }

    @Override
    public int hashCode() {
      return Objects.hash(path, contentUri, mimeType);
    }
    ...
    public static final class Builder {
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setContentUri(@Nullable String setterArg) {
        this.contentUri = setterArg;
        return this;
      }
      ...
      public @NonNull PickedMedia build() {
        PickedMedia pigeonReturn = new PickedMedia();
        pigeonReturn.setPath(path);
        pigeonReturn.setContentUri(contentUri);
    ...
    ArrayList<Object> toList() {
      ...
      toListResult.add(contentUri);
      toListResult.add(mimeType);
      return toListResult;
    }

    static @NonNull PickedMedia fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      PickedMedia pigeonResult = new PickedMedia();
      Object path = pigeonVar_list.get(0);
      pigeonResult.setPath((String) path);
      Object contentUri = pigeonVar_list.get(1);
      pigeonResult.setContentUri((String) contentUri);
  ...
  private static class PigeonCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 136:
          return PickedMedia.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 137:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof PickedMedia) {
        stream.write(136);
        writeValue(stream, ((PickedMedia) value).toList());
  ...
  public interface ImagePickerApi {
    ...
    void pickImages(@NonNull SourceSpecification source, @NonNull ImageSelectionOptions options, @NonNull GeneralOptions generalOptions, @NonNull Result<List<PickedMedia>> result);
    /** Selects video and returns their paths with content URIs. */
    void pickVideos(@NonNull SourceSpecification source, @NonNull VideoSelectionOptions options, @NonNull GeneralOptions generalOptions, @NonNull Result<List<PickedMedia>> result);
    /** Selects images and videos and returns their paths with content URIs. */
    void pickMedia(@NonNull MediaSelectionOptions mediaSelectionOptions, @NonNull GeneralOptions generalOptions, @NonNull Result<List<PickedMedia>> result);
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable ImagePickerApi api) {
      ...
      BinaryMessenger.TaskQueue taskQueue = binaryMessenger.makeBackgroundTaskQueue();
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.image_picker_plus_android.ImagePickerApi.pickImages" + messageChannelSuffix, getCodec(), taskQueue);
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                Result<List<PickedMedia>> resultCallback =
                    new Result<List<PickedMedia>>() {
                      public void success(List<PickedMedia> result) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.image_picker_plus_android.ImagePickerApi.pickVideos" + messageChannelSuffix, getCodec(), taskQueue);
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.image_picker_plus_android.ImagePickerApi.pickMedia" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.image_picker_plus_android.ImagePickerApi.retrieveLostResults" + messageChannelSuffix, getCodec(), taskQueue);
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
